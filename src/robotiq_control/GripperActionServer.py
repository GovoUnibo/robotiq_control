...
if __name__ == "__main__":
    ...
    print('AS get Param')
    gripper_name  = rospy.get_param('~gripper_name','/ur5/command_robotiq_action')
    ...
    server_gripper = RobotiqGripperActionServer(action_server_name= gripper_name, gripper_type = RobotiqGripperType.Hand_E, usbComPort = usb_port)
